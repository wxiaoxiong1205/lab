...
const pageDocs: PageDocEntry[] = [
  ...
  },
  {
    ...
    doc: createDoc({
      ...
      productionComparison: ['生产系统配置当前已覆盖属性配置与标签配置。', '生产替换期已确认：模板管理仍是 V1.14 未覆盖缺口，不能直接迁入 Demo localStorage；后续应以生产后端持久化模板配置为真相源。'],
