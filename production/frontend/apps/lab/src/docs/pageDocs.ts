  ...
  },
  {
    ...
    doc: createDoc({
      ...
      interactionNotes: [
        ...
        '删除失败时目标行恢复正常展示，数据详情标题旁红色提示展示已成功/已失败数量和失败原因；命中的失败行在表格中标红，并在操作列提供重试删除；关闭顶部提示只隐藏提示条，不清除失败行和行内重试入口；普通创建中状态只在版本侧栏和基本信息中展示，不额外占用版本操作状态。',
      ],
