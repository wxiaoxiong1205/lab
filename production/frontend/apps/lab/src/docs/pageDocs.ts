        ...
        },
        {
          ...
          content: formatRequirementDoc({
            ...
            acceptance: [
              ...
              '合并版本基本信息中的数据来源展示为“版本合并”，不展示具体来源关系。',
            ],
            interactions: [
