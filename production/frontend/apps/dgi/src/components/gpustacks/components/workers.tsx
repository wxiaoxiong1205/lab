...
import type { Filesystem, GPUDeviceItem, ListItem } from '../config/types'
...
const Workers: React.FC = () => {
  ...
  const {
    ...
    fetchAPI: queryWorkersList as any,
                ...
                <span className="flex-column flex-gap-2">
                  {_.map(
                    ...
                    (item: GPUDeviceItem, index: string) => {
                      return (
                        <span className="flex-center flex" key={index}>
                          <span
                            className="m-r-5"
                ...
                <span className="flex-column flex-gap-2">
                  {_.map(
                    ...
                    (item: GPUDeviceItem, index: string) => {
                      return (
                        <span key={index}>
                          <span className="flex-center flex">
                            <span
                              className="m-r-5"
                              style={{ display: 'flex', width: 25 }}
                            >
