...
import { GPU_DEVICES_API, queryGpuDevicesList } from '../api/index'
import type { GPUDeviceItem } from '../config/types'
...
const GPUList: React.FC = () => {
  const {
    ...
    fetchAPI: queryGpuDevicesList as any,
    polling: true,
    API: GPU_DEVICES_API,
  })
  ...
  return (
    <>
      ...
      <FilterBar
        marginBottom={22}
        marginTop={30}
        buttonText="resources.button.create"
      ...
      <ConfigProvider renderEmpty={renderEmpty}>
        ...
        >
          ...
          />
          <Column
            title="resources.table.workername"
          ...
          />
          <Column
            title="resources.table.vender"
            dataIndex="vendor"
            key="vendor"
          />

          <Column
            title={` resources.table.temperature`}
          ...
          />
          <Column
            title="resources.table.gpuutilization"
            dataIndex="gpuUtil"
            key="gpuUtil"
            render={(text, record: GPUDeviceItem) => {
              return (
          ...
          <Column
            title="resources.table.vramutilization"
            dataIndex="VRAM"
            key="VRAM"
            render={(text, record: GPUDeviceItem) => {
              return (
