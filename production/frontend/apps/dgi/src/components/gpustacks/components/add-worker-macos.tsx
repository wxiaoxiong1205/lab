...
const AddWorkerMacOS: React.FC<AddWorkerMacOSProps> = ({ platform }) => {
  ...
  const labels = useMemo(
    () => ({
      step1: 'resources.worker.add.step1',
      step2: 'resources.worker.add.step2',
      step2Tips: 'resources.worker.add.step2.tips',
      step3: 'resources.worker.add.step3',
      linuxOrMac: 'resources.worker.linuxormaxos',
    }),
    [],
  )
  return (
    <div className="script-install">
      <h3 className="font-size-14 font-600">
        1.
        {' '}
        resources.register.install.title
        {/* {intl.formatMessage(
      ...
      <Typography.Paragraph type="secondary" style={{ paddingLeft: 14 }}>
        <span
          ...
          // }}
          dangerouslySetInnerHTML={{
            __html: 'resources.register.download',
          }}
        >
        </span>
      ...
      <h3 className="font-size-14 font-600">
        2.
        {' '}
        <span dangerouslySetInnerHTML={{ __html: labels.step1 }}></span>
      </h3>
      <Typography.Paragraph style={{ paddingLeft: 14 }}>
        <div className="flex">
          <Typography.Text type="secondary">
            <span
              dangerouslySetInnerHTML={{
                __html: 'resources.register.worker.step1',
              }}
            >
            </span>
          </Typography.Text>
