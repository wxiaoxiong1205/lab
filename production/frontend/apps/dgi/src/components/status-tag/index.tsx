import { StatusColorMap } from '@/components/gpustacks/config'
import type { StatusType } from '@/components/gpustacks/config/types'
...
import CopyStyle from './copy-btn.module.css'
import './index.css'
