...
export const MODELS_API = `${GPU_STACK_API}/models`

export const MODEL_INSTANCE_API = `${GPU_STACK_API}/model-instances`

export const MODEL_EVALUATIONS = `${GPU_STACK_API}/model-evaluations`
...
export async function queryModelsInstances(params: Global.SearchParams, options?: any) {
...
export async function queryModelsList(params: Global.SearchParams, options?: Record<string, any>) {
  return request<Global.PageResponse<ListItem>>({
    url: `${MODELS_API}?${qs.stringify(params)}`,
    method: 'GET',
    ...options,
  })
}
...
export async function queryGPUList(params?: Global.SearchParams) {
  return request<Global.PageResponse<GPUListItem>>({
    url: `${GPU_STACK_API}/gpu-devices`,
    method: 'GET',
    params,
  })
}
...
export async function queryModelInstancesList(
  ...
  return request<Global.PageResponse<ModelInstanceListItem>>({
    url: `${MODELS_API}/${params.id}/instances`,
    method: 'GET',
    params,
    cancelToken: options?.token,
  })
...
export async function createModelInstance(params: { data: ModelInstanceFormData }) {
  return request({
    url: MODEL_INSTANCE_API,
    method: 'POST',
    data: params.data,
...
export async function deleteModelInstance(id: number) {
  return request({
    url: `${MODEL_INSTANCE_API}/${id}`,
    method: 'DELETE',
  })
}

export async function updateModelInstance(params: { id: number, data: FormData }) {
  return request({
    url: `${MODEL_INSTANCE_API}/${params.id}`,
    method: 'PUT',
    data: params.data,
  })
}
...
export async function queryModelInstanceLogs(id: number) {
  return request({
    url: `${MODEL_INSTANCE_API}/${id}/logs`,
    method: 'GET',
  })
}
...
export async function queryHuggingfaceModelDetail(params: { repo: string }, options?: any) {
...
export async function queryModelScopeModelDetail(params: { name: string }, options?: any) {
  return request({
    url: setProxyUrl(`${MODE_SCOPE_MODEL_FIELS_API}${params.name}`),
    method: 'GET',
    cancelToken: options?.token,
  })
}
...
export async function queryHuggingfaceModelFiles(
  ...
  for await (const fileInfo of listFiles({
    ...params,
    recursive: true,
    fetch(url: RequestInfo | URL, config: any) {
      try {
        return fetch(setProxyUrl(url.toString()), {
          ...config,
          signal: options?.signal,
        })
      }
...
export async function downloadModelScopeModelfile(params: { name: string }, options?: any) {
...
export async function queryCatalogList(params: Global.SearchParams, options?: any) {
  return request<Global.PageResponse<CatalogItem>>({
    url: `/model-sets?${qs.stringify(params)}`,
    method: 'GET',
    ...options,
  })
}

export async function queryCatalogItemSpec(params: { id: number }, options?: any) {
  return await request<Global.PageResponse<CatalogSpec>>({
    url: `/model-sets/${params.id}/specs`,
    method: 'GET',
    ...options,
    params,
  })
...
export async function evaluationsModelSpec(
  ...
  return request<{ results: EvaluateResult[] }>({
    url: MODEL_EVALUATIONS,
    method: 'POST',
    data,
    cancelToken: options?.token,
  })
