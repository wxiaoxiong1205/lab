...
- 方法路径：`GET /openapi/lab/v1/training-datasets/project/{project_id}/dataset/{dataset_name}/version/{version}/preview`
...
- 图像理解数据集会返回 `base_url`，用于拼接样本中的图片相对路径；非图像理解数据集通常为 `null`。
