...
export const ROUTE_ACCESS_RULES: RouteAccessRule[] = [
  ...
  { menuKey: '/service/inference/external', requiresProject: false, match: pathname => pathname === '/service/inference/external/create' },
  { menuKey: '/service/inference/external', requiresProject: true, match: pathname => pathname === '/service/inference/external' || pathname.startsWith('/service/inference/external/') },
  { menuKey: '/machine-data-management', requiresProject: true, match: pathname => pathname === '/machine-data-management' || pathname.startsWith('/machine-data-management/') },
  { menuKey: '/machine-annotation', requiresProject: true, match: pathname => pathname === '/machine-annotation' },
  { menuKey: '/machine-model-management', requiresProject: true, match: pathname => pathname === '/machine-model-management' || pathname.startsWith('/machine-model-management/') },
  ...
  { menuKey: '/machine-notebook', requiresProject: true, match: pathname => pathname === '/machine-notebook' || pathname.startsWith('/machine-notebook/') },
  { menuKey: '/machine-annotation-service', requiresProject: true, match: pathname => pathname === '/machine-annotation-service' || pathname === '/machine-online-annotation-service' },
