  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        key: '/admin/registry',
        label: '镜像管理',
        children: [{ key: 'admin.registry.manage', label: '镜像管理' }],
      },
      {
...
export const OPERATION_DEFINITION_MAP: Record<string, OperationDefinition> = {
  ...
  'admin.registry.manage': { key: 'admin.registry.manage', label: '镜像管理', menuKey: '/admin/registry', requiresProject: false },
...
export const ROUTE_ACCESS_RULES: RouteAccessRule[] = [
  ...
  { menuKey: '/machine-model-deployment', requiresProject: true, match: pathname => pathname === '/machine-model-deployment' },
