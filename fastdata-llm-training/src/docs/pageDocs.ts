...
const pageDocs: PageDocEntry[] = [
  ...
  },
  {
    ...
    doc: createDoc({
      ...
      structure: ['筛选区', '可横向滚动的 Notebook 列表', '上下分区的卡片式创建页', '带顶部操作区的整页详情', '广场案例卡片', '案例详情页', '发布案例页'],
      fields: [
      ...
      actions: [
        ...
        { name: '发布为案例', entry: '我的Notebook列表行操作', precondition: '目标 Notebook 存在', successFeedback: '进入发布案例页并填写案例名称、案例说明后发布', errorFeedback: 'Notebook 不存在时提示无法发布' },
