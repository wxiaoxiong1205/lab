  ...
  },
  {
    ...
    doc: createDoc({
      ...
      fields: [
        ...
        { name: '训练加速配置', location: '创建表单/训练配置', type: '开关 + 单选策略', required: '否', description: '基于 DeepSpeed ZeRO 显存优化策略，默认关闭；开启后以 Radio 单选形式展示 ZeRO-0、ZeRO-2、ZeRO-3，每个类型保留短说明和悬浮注释。' },
