      ...
      defaultRequirements: [
        {
          ...
          content: formatRequirementDoc({
            ...
            acceptance: [
              ...
              '未发布版本可删除当前版本内单条数据并发布，发布前不做额外强校验。',
