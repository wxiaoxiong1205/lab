      ...
      defaultRequirements: [
        {
          ...
          content: formatRequirementDoc({
            ...
            acceptance: [
              ...
              '定时待启动、启动中、排队中状态标题旁展示“资源即将被占用”；运行中状态标题旁展示“资源正在使用中”。',
