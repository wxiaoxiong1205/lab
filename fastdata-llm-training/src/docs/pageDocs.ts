  ...
  },
  {
    ...
    doc: createDoc({
      ...
      fields: [
        ...
        { name: 'DPO Alpaca 标注', location: '标注详情工作台', type: 'Instruction/Input/Chosen/Rejected', required: '是', description: 'DPO-Alpaca 数据进入标注页后，表格除序号、进度和操作外直接按 Instruction、Input、Chosen、Rejected 字段展开展示。' },
        { name: 'DPO Role-Based 标注', location: '标注详情工作台', type: 'Messages/Chosen/Rejected', required: '是', description: 'DPO-Role-Based 数据进入标注页后，表格除序号、进度和操作外直接按 Messages、Chosen、Rejected 字段展开展示，system 和 user 均在 Messages 内。' },
