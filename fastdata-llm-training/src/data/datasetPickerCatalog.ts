...
export const DATASET_PICKER_CATALOG: DatasetPickerItem[] = [
  ...
  {
    id: 'ds_val_dpo_role_1',
    name: '验证-DPO-Role-Based-质量偏好',
    latestVersion: 'V1',
    dataType: '验证数据集',
    dataUsage: '文本生成',
    dataFormat: 'ROLE_BASED',
